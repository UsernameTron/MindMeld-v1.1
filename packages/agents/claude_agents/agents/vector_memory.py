# @deprecated
# This file has been moved to packages/agents/claude_agents/memory/vector_memory_agent.py
...
class EmbeddingService:
    ...
    def get_embedding(self, content: str, metadata: Optional[Dict[str, Any]] = None):
        """Stub method - replace with actual embedding logic"""
        return {"vector": [0.0] * 128}  # Example: 128-dimensional zero vector

    def compute_similarity(self, vector1: List[float], vector2: List[float]) -> float:
        """Stub method - replace with actual similarity computation"""
        return 0.0


class Agent:
    """Stub for Agent - replace with actual implementation"""
...
class VectorMemoryAgent(Agent):
    ...
    def __init__(
        ...
        llm_client: Optional[object] = None,  # Use object for now
        ...
        self.llm_client = llm_client  # Remove LLMClientFactory usage
