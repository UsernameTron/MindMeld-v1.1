...
- Name: Tampered cookies should fail authentication
- Location: /Users/cpconnor/projects/mindmeld-fresh/e2e/playwright/auth-flow.spec.ts:63:5
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at /Users/cpconnor/projects/mindmeld-fresh/e2e/playwright/auth-flow.spec.ts:69:14
```
