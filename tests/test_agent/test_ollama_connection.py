...
class TestOllamaConnection:
    ...
    def test_wait_for_ollama_timeout(self, mock_sleep, mock_get):
        ...
        with patch('logging.Logger.info') as mock_log, \
            ...
            args = wait_for_ollama.parse_args(['--host', 'http://localhost:11434', 
                                 '--timeout', '10', 
                                 '--interval', '2'])
    ...
    def test_model_checking(self, mock_check_model, mock_get):
        ...
        # Act
        with patch('wait_for_ollama.pull_model') as mock_pull, \
             patch('logging.Logger.info') as mock_log:
            result = wait_for_ollama.ensure_model_available("http://localhost:11434", "llama2")
...
class TestAgentOllamaErrorHandling:
    ...
    def test_connection_error_handling(self, mock_client):
        ...
        mock_client_instance.chat.side_effect = ConnectionError("Failed to connect to Ollama")
