...
from exceptions import InputValidationError, SchemaValidationError, ValidationError
...
class TestAgentImplementations(unittest.TestCase):
    ...
    def test_summarizer_agent(self):
        ...
        self.assertIsNotNone(
            summarizer_factory, "Summarizer agent not found in registry"
        )
    ...
    def test_code_debugger_agent(self):
        ...
        self.assertEqual(
            AGENT_INPUT_TYPES.get("CodeDebuggerAgent"),
            "file",
