...
def test_emotion_detection_positive_text():
    service = AnalyzeService.get_instance()
    request = SentimentRequest(text="I'm thrilled and excited about this wonderful news!", include_emotions=True)
    response = service.analyze_sentiment(request)
...
def test_emotion_detection_negative_text():
    service = AnalyzeService.get_instance()
    request = SentimentRequest(text="I'm feeling very angry and frustrated about this situation.", include_emotions=True)
    response = service.analyze_sentiment(request)
...
def test_batch_sentiment_with_emotions():
    ...
    request = BatchSentimentRequest(
        texts=["I'm so happy!", "I'm very angry."], 
